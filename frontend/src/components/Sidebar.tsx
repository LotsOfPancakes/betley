      ...
      <nav className="flex-1 px-6">
        <div className="space-y-2">          
          ...
          <div className="relative">
            ...
            >
              <span className="font-medium">Add Betley to Telegram</span>
            ...
            {showTelegramTooltip && (
              <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 w-64 p-3 bg-gray-800 border border-gray-600 rounded-lg shadow-xl text-sm text-gray-200 z-50">
                <div className="text-center">
                  Betley on Telegram allows you to quickly and easily create bets from your groups for easier betting!
                </div>
