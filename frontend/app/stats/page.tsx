    ...
    <div className="relative overflow-hidden rounded-xl bg-gray-800/60 backdrop-blur-sm border border-gray-700/50 shadow-sm hover:shadow-lg hover:border-gray-600/50 transition-all duration-200">
      ...
      <div className="relative p-6">
        <div className="flex items-center justify-between mb-3">
          <div className={`w-12 h-12 rounded-lg bg-gradient-to-br ${gradient} flex items-center justify-center text-white text-xl font-bold shadow-sm`}>
            {icon}
          </div>
...
function LoadingStats() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      {[...Array(4)].map((_, i) => (
        <div key={i} className="rounded-xl bg-gray-800/60 backdrop-blur-sm border border-gray-700/50 shadow-sm">
          <div className="p-6">
            <div className="flex items-center justify-between mb-3">
        ...
        <div className="max-w-6xl mx-auto px-4 py-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-300 mt-2">Track your betting performance and impact on Betley</p>
            </div>
            <div className="text-right">
          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              ...
              <StatCard
                ...
                value={`${formatHype(stats.total_volume_created)} HYPE`}
              ...
              <StatCard
                ...
                value={`${formatHype(stats.total_volume_bet)} HYPE`}
            ...
            {stats.bets_created === 0 && (
              <div className="bg-gray-800/60 backdrop-blur-sm rounded-xl border border-gray-700/50 p-8 text-center">
                ...
                <p className="text-gray-400 mb-6">Create your first bet to start tracking your impact on Betley!</p>
                <button 
                  onClick={() => window.location.href = '/setup'}
                  className="bg-gradient-to-r from-blue-500 to-purple-600 text-white px-6 py-3 rounded-xl font-medium hover:from-blue-600 hover:to-purple-700 transition-all duration-200 hover:scale-105"
                >
